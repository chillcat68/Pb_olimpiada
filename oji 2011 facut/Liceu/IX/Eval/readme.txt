...
- Se lanseaza evaluatorul (short-cut pe desktop).

- Se copiaza sursele concurentilor in folderele: 
          Eval_OJI_2011_IX\probleme\[nume_problema_1]\surse_concurenti 
	
	  Eval_OJI_2011_IX\probleme\[nume_problema_2]\surse_concurenti
